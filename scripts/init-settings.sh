...
# 将默认 SSID 改为根据频段区分
sed -i 's/set wireless\.default_radio\${devidx}\.ssid=LEDE/set wireless.default_radio${devidx}.ssid=$([ "$mode_band" = "2g" ] \&\& echo "OpenWrt-2.4" || echo "OpenWrt5G")/' package/kernel/mac80211/files/lib/wifi/mac80211.sh
